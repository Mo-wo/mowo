...
export const projects: Project[] = [
  {
    ...
    summary: "Self-custodial crypto wallet and P2P marketplace with real-time trading, chat, and multi-platform support.",
    contributions: [
      "Designed and implemented a cross-platform design system for mobile, web, and admin dashboards",
      "Built reusable component architecture to support scalable feature development across platforms",
      "Implemented real-time trading and chat flows using WebSockets",
      "Handled complex transaction states, including loading, failures, and edge-case scenarios",
    ],
    impact: [
      "Enabled seamless trading across 40+ cryptocurrencies and multiple blockchains",
      "Improved consistency and maintainability across mobile, web, and admin platforms",
      "Enhanced user experience with reliable real-time interactions and state handling",
    ],
  ...
  },
  {
    ...
    summary: "Social platform for football fans with real-time chat, live streaming, and gamified engagement systems.",
    contributions: [
      "Built mobile application with real-time chat and live video streaming using WebSockets and Agora SDK",
      "Implemented event-driven features including live match discussions and interactive engagement flows",
      "Developed gamification system with rewards, leaderboards, and user engagement tracking",
      "Built admin dashboard for managing products, users, and platform data with full CRUD operations",
    ],
    impact: [
      "Enabled real-time fan interaction during live events with low-latency communication",
      "Increased user engagement through gamification and interactive features",
      "Provided scalable admin tools for managing complex platform operations",
    ],
  ...
  },
  {
    ...
    summary: "Multi-language web platform with admin dashboard for managing a steel fabrication and finishing company's workflows and content.",
    contributions: [
      "Implemented full internationalsation with i18next, supporting English and Norwegian languages",
      "Developed admin dashboard with data management features and UI enhancements",
      "Built reusable components and improved responsive design for better user experience",
      "Integrated frontend with backend APIs, handling data states and edge-case scenarios",
    ],
    impact: [
      "Expanded platform accessibility to multiple language audiences",
      "Improved content and workflow management through admin tools",
      "Enhanced user experience with consistent and responsive UI",
    ],
  ...
  },
  {
    ...
    summary: "Beauty services platform with booking, discovery, and business management features.",
    contributions: [
      "Built complete frontend architecture with routing, state management, and responsive UI",
      "Designed and implemented a reusable component system using SCSS and BEM methodology",
      "Developed booking and discovery flows with structured UI and data handling",
      "Implemented SEO optimisation including metadata, sitemap, and structured data",
    ],
    impact: [
      "Enabled seamless discovery and booking of beauty services",
      "Improved development speed through reusable design system",
  ...
  },
  {
    ...
    summary: "Travel platform optimised for SEO, performance, and accessibility to improve search visibility and user experience.",
    contributions: [
      "Implemented technical SEO including metadata, sitemap, robots.txt, and structured data",
      "Optimised Core Web Vitals using image optimisation, code splitting, and efficient loading strategies",
      "Improved accessibility with semantic HTML and structured content",
      "Configured Google Search Console and business profile integration",
    ],
    impact: [
      "Improved search engine visibility and crawlability",
      "Enhanced performance and loading speed across pages",
      "Delivered accessible and user-friendly browsing experience",
    ],
